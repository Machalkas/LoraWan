...
class ClickHouseDriver:
    ...
    def __init__(self, child_self, min_inserts_count: Optional[int] = None, max_inserts_count: int = 100, timeout_sec: int = 10):
        print("init")
    ...
    def event_loop(self, loop: asyncio.AbstractEventLoop):
        ...
        loop.run_until_complete(self.clickhouse_query_executor())
...
class ClickHouseWriter(ClickHouseDriver):
    def __init__(self,
        ...
        super().__init__(max_inserts_count=max_inserts_count, min_inserts_count=min_inserts_count, timeout_sec=timeout_sec, child_self=self)
