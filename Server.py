...
def procDataResp(data):
	...
	if ((COM == 1) & (ID == 1)):
		...
		id = saveData1.insert_one(currentSavings1_).inserted_id
		print(id)
		cursor = saveData1.find({})
	...
	if ((COM == 1) & (ID == 5)):
		...
		id = saveData3.insert_one(currentSavings3_).inserted_id
		print(id)
		cursor = saveData3.find({})
		for document in cursor:
			print(document)
	...
	if ((COM == 1) & (ID == 3)):
		...
		id = saveData2.insert_one(currentSavings2_).inserted_id
		print(id)
		cursor = saveData2.find({})
		for document in cursor:
			print(document)
	...
	if ((COM == 1) & (ID == 11)):
		...
		id = saveData4.insert_one(currentSavings4_).inserted_id
		print(id)
		cursor = saveData4.find({})
		for document in cursor:
			print(document)
...
def on_open(ws):
	def run(*args):
		devInfo = {}
		devEui = ['70B3D58FF0038598', '70B3D58FF1015023', '70B3D58FF1014756', '70B3D58FF101497F', '70B3D58FF1014704',
		          '70B3D58FF101470F', '70B3D58FF1014754', '70B3D58FF10146FD']
		...
		while i < len(devEui):
			...
			get_data_req = json.dumps(
					{'cmd': 'get_data_req', 'devEui': devEui[i], 'select': {'direction': 'UPLINK'}})
